...
public class Boss extends Player implements IBossNew, IBossOutfit {
    ...
    public Player getPlayerAttack() {
        if (this instanceof AnTrom && (this.playerTarger == this.pet || this.playerTarger == this.thuTrieuHoi || this.playerTarger == this.newpet || Util.canDoWithTime(this.lastTimeTargetPlayer, this.timeTargetPlayer))) {
