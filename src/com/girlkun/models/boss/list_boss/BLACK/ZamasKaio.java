...
public class ZamasKaio extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(BossManager.ratioReward, 100)) {
            if (Util.isTrue(1, 5)) {
             Service.gI().dropItemMap(this.zone,new ItemMap(zone, 2031, 5, this.location.x, this.location.y, plKill.id));
                return;
            }
            ...
            Service.gI().dropItemMap(this.zone, new ItemMap(zone, 457, 5, this.location.x, this.location.y, plKill.id));
        }
