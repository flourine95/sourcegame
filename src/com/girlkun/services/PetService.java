...
public class PetService {
    ...
    public void changeNamePet(Player player, String name) {
        try {
            ...
            Logger.logException(PetService.class, ex, "Error change name Pet: " + player.name);
        }
    }
    ...
    public static void createThuTrieuHoi(Player pl) {
        ...
        pl.thuTrieuHoi.nPoint.power = 1;
        pl.thuTrieuHoi.nPoint.limitPower = 1;
        pl.thuTrieuHoi.nPoint.hpg = pl.TrieuHoiHP;
        pl.thuTrieuHoi.nPoint.mpg = 500000000;
        pl.thuTrieuHoi.nPoint.hp = pl.TrieuHoiHP;
        pl.thuTrieuHoi.nPoint.mp = 500000000;
        pl.thuTrieuHoi.nPoint.dameg = pl.TrieuHoiDame;
        pl.thuTrieuHoi.nPoint.defg = 1;
        pl.thuTrieuHoi.nPoint.critg = 1;
        pl.thuTrieuHoi.nPoint.stamina = 10000;
        pl.thuTrieuHoi.nPoint.maxStamina = 10000;
        pl.thuTrieuHoi.playerSkill.skills.add(SkillUtil.createSkill(17, 7));
        pl.thuTrieuHoi.nPoint.setBasePoint();
        pl.thuTrieuHoi.nPoint.setFullHpMp();
    }
}
